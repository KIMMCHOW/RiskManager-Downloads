...
| --- | --- | --- | --- | --- |
| 4.6.2 | ATAS X | [RiskManager-4.6.2-ATAS-X.dll](正式版/ATAS%20X/RiskManager-4.6.2/RiskManager-4.6.2-ATAS-X.dll) | [使用教程 / User Guide](docs/使用教程.md) | [更新日志 / Changelog](docs/用户版更新日志.md) |
| 4.6.2 | ATAS 8.x | [RiskManager-4.6.2-ATAS-8.x.dll](正式版/8.x/RiskManager-4.6.2/RiskManager-4.6.2-ATAS-8.x.dll) | [使用教程 / User Guide](docs/使用教程.md) | [更新日志 / Changelog](docs/用户版更新日志.md) |
| 4.6.2 | ATAS 7.x | [RiskManager-4.6.2-ATAS-7.x.dll](正式版/7.x/RiskManager-4.6.2/RiskManager-4.6.2-ATAS-7.x.dll) | [使用教程 / User Guide](docs/使用教程.md) | [更新日志 / Changelog](docs/用户版更新日志.md) |
...
| --- | --- | --- | --- | --- | --- | --- |
| 4.6.2 | ATAS X | [DLL](正式版/ATAS%20X/RiskManager-4.6.2/RiskManager-4.6.2-ATAS-X.dll) | [更新日志 / Changelog](docs/用户版更新日志.md) | — | — | — |
| 4.6.2 | 8.x | [DLL](正式版/8.x/RiskManager-4.6.2/RiskManager-4.6.2-ATAS-8.x.dll) | [更新日志 / Changelog](docs/用户版更新日志.md) | — | — | — |
| 4.6.2 | 7.x | [DLL](正式版/7.x/RiskManager-4.6.2/RiskManager-4.6.2-ATAS-7.x.dll) | [更新日志 / Changelog](docs/用户版更新日志.md) | — | — | — |
