...
这里是 RiskManager 的公开下载仓库，只保留正式版 DLL 文件和对应版本说明，不包含商业版源码。

## 最新正式版

| 版本 | DLL | 说明 |
| --- | --- | --- |
| 4.2.1 | [RiskManager-4.2.1.dll](正式版/4.2/RiskManager-4.2.1/RiskManager-4.2.1.dll) | [发布说明](正式版/4.2/RiskManager-4.2.1/RELEASE_NOTES-4.2.1.md) |
...
开源版仓库：[zhouzhen705/ATAS-RiskManager](https://github.com/zhouzhen705/ATAS-RiskManager)

## 下载方式

打开对应 DLL 链接后，点击 GitHub 页面右上角的下载按钮即可下载。
