...
- 下载与当前 ATAS 版本匹配的 DLL：`RiskManager-4.2.5-ATAS-X.dll`。
  Download the DLL that matches your ATAS version: `RiskManager-4.2.5-ATAS-X.dll`.
...
- 本包适用于 ATAS X，目标框架为 `net10.0-windows`。
  This package is for ATAS X and targets `net10.0-windows`.
- 不要混用不同 ATAS 版本的 DLL。
